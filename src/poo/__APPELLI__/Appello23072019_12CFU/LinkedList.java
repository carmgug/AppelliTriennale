...
import poo.util.AbstractList;

//aggiunto il CompareTO da me;
public class LinkedList<T extends Comparable<? super T>> extends AbstractList<T>{
	...
	public  void BubbleSort(LinkedList<Integer> l) {
        if (size > 1) {
            boolean wasChanged;
